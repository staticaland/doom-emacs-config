...
#+begin_src elisp
(defmacro +macos--open-with-ghostty (id &optional dir newwindow?)
  `(defun ,(intern (format "+macos/%s" id)) ()
     (interactive)
     (+macos-open-with "Ghostty" ,dir)))

;;;###autoload (autoload '+macos/open-in-ghostty "os/macos/autoload" nil t)
(+macos--open-with-ghostty open-in-ghostty default-directory)

;;;###autoload (autoload '+macos/open-in-ghostty-new-window "os/macos/autoload" nil t)
(+macos--open-with-ghostty open-in-ghostty-new-window default-directory t)

;; Bind the new commands
(map! :leader
      (:prefix-map ("o" . "open")
