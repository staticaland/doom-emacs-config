...
Du har PTSD fra skolen. Det er lov å ikke forstå i starten, det er meningen. Jeg føler meg sånn hver dag.

From the Outline manual we can get some hints about how heading levels work.
