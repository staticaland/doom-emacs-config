...
I also set up some hooks for =outline-mode=. The one for =org-src-mode-hook=
toggles =outline-minor-mode= off in practice. I should probably clean up this
later.
...
=outline-regexp= match, or a association in =outline-heading-alist=. You can
...
Here is the default =outline-level= function:
...
- [[https://old.reddit.com/r/emacs/comments/e2u5n9/code_folding_with_outlineminormode/][Reddit - Code folding with outline-minor-mode]]
- [[https://www.modernemacs.com/post/outline-ivy/][Managing code with Outlines | Modern Emacs]]
- [[https://github.com/ekaschalk/.spacemacs.d/tree/master/layers/display/local/pretty-outlines][Spacemacs - pretty-outlines layer]]
- [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Outline-Format.html][Outline Format - GNU Emacs Manual]]
- [[https://github.com/emacsorphanage/terraform-mode/issues/20][GitHub - terraform-mode - Provide folding of blocks]]
